...
public class Land implements BaseModel, Serializable, Cloneable {
    ...
    @SerializedName("2_wheeler_price")
    public String twoWheelerPrice;

    @SerializedName("4_wheeler_price")
    public String fourWheelerPrice;

    public String getTwoWheelerPrice() {
        return twoWheelerPrice;
    }

    public String getFourWheelerPrice() {
