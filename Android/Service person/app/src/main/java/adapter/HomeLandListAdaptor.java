...
public class HomeLandListAdaptor extends RecyclerView.Adapter<HomeLandListAdaptor.HomeLandListAdaptorViewHolder>{
    ...
    @NonNull
    @Override
    public HomeLandListAdaptorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemHomeLandListBinding binding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.getContext()),
                R.layout.item_home_land_list, parent, false);

        return new HomeLandListAdaptorViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeLandListAdaptorViewHolder holder, int position) {
